...
CREATE INDEX idx_pool_keys_chain_id_token0_token1_extension ON pool_keys USING btree (chain_id, token0, token1, EXTENSION);
...
CREATE INDEX idx_position_updates_locker_salt ON position_updates USING btree (chain_id, locker, salt);

CREATE INDEX idx_position_updates_salt ON position_updates USING btree (chain_id, salt);
