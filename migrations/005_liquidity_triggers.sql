...
BEGIN
	...
	UPDATE
		per_pool_per_tick_liquidity_incremental_view
	SET
	...
	IF NOT found THEN
		INSERT INTO per_pool_per_tick_liquidity_incremental_view (pool_key_id, tick, net_liquidity_delta_diff, total_liquidity_on_tick)
