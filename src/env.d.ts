...
interface EvmConfig extends CommonConfiguration {
  ...
  GET_LOGS_RANGE_SIZE?: string; // Widest block span per eth_getLogs; defaults to 1000
  REORG_WINDOW_BLOCKS?: string; // How far back to re-read at the head to notice a reorg; defaults to 64
